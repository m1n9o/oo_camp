...
public class SmartParkingBoyTest {
    @Test
    void should_park_car_in_A_and_get_ticket_when_park_given_two_parking_lots_A_B_and_2_left_in_A_while_1_left_in_B() {
    ...
    @Test
    void should_park_car_in_A_and_get_ticket_when_park_given_two_parking_lots_A_B_and_1_left_in_A_while_2_left_in_B() {
    ...
    @Test
    void should_park_car_in_B_and_get_ticket_when_park_given_two_parking_lots_A_B_and_2_left_in_A_while_2_left_in_B() {
        ParkingLot parkingLotA = new ParkingLot(2);
        ParkingLot parkingLotB = new ParkingLot(2);
    ...
    @Test
    void should_notice_parking_log_is_full_when_park_given_two_parking_lots_A_B_and_0_left_in_A_while_0_left_in_B() {
        ParkingLot parkingLotA = new ParkingLot(1);
        ParkingLot parkingLotB = new ParkingLot(1);
    ...
    @Test
    void should_notice_invalid_ticket_when_pick_up_given_the_car_is_not_in_the_parking_lot_managed_by_this_smart_boy() {
        ParkingLot parkingLotA = new ParkingLot(1);
        ParkingLot parkingLotB = new ParkingLot( 1);
